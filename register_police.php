   ...
   <div class="section">
            ...
            <div class="row">
              <div class="col s12 center">
                ...
                <h4>Register as a Police</h4>
                <h5></h5>
                <br/>
                <div class="row">
                  <form class="col s12" method="POST" action="police_reg.php" id="contact-form">
                    <div class="row">
                      ...
                      <div class="input-field col s6">
                        ...
                        <input id="icon_telephone" name="unique_id" type="text" length="10" size="10" class="validate" required>
                        <label for="icon_telephone">Unique ID</label>
                      </div>
                      <div class="input-field col s6">
                        <i class="mdi-communication-location-on prefix"></i>
                        <input id="icon_lat" name="latitude" type="text" class="validate" required>
                        <label for="icon_lat">Latitude</label>
                      </div>
                      <div class="input-field col s6">
                        <i class="mdi-maps-pin-drop prefix"></i>
                        <input id="icon_lon" name="longitude" type="text" class="validate" required>
                        <label for="icon_lon">Longitude</label>
                      </div>
                   </div>
                      <div class="row">
                        <div class="input-field col s12">
                           <div id="dvMap" style="margin-left:22%;width:800px;height:300px;" />                        
                        </div>
                      </div>
                   <div class="row">
                      <div class="input-field col s6">
